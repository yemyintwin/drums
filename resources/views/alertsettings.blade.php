...
<head>
    ...
    <script src="assets/js/alertsettings.js?v=191008_2341"></script>
</head>
...
<body>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div id="table-wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div id="table_alert_setting"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="panel-footer">
                            <div class="btn-group" role="group">
                                <button class="btn btn-default" type="button" data-toggle="modal" data-target="#registration_alert_setting" id="btnNewSetting" onclick="alertSettings.btnNewSetting_OnClick();">New</button>
                                <button class="btn btn-default" type="button" data-toggle="modal" data-target="#registration_alert_setting" id="btnEditSetting" onclick="alertSettings.btnEditSetting_OnClick();">Edit</button>
                                <button class="btn btn-default" type="button" id="btnDelSetting" onclick="alertSettings.btnDelSetting_OnClick();">Delete</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!--Model dialog-->
    <div>
        <div class="modal fade" role="dialog" tabindex="-1" id="registration_alert_setting" aria-labelledby="registrationLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form class="form-horizontal" role="form" id="form_alertSetting" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 control-label" for="engineModal">Engine Modal</label>
                                <div class="col-sm-8">
                                    <select class="form-control" id="engineModel" name="engineModel"></select>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4 control-label" for="channelNo">Channel No.</label>
                                <div class="col-sm-8">
                                    <select class="form-control" id="channelNo" name="channelNo"></select>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4 control-label" for="condition">Condition</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 control-label" for="level">Alert Level</label>
                                <div class="col-sm-8">
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-primary" type="submit" id="btnSettingSubmit">Save</button>
                        </div>
                    </form>
                </div>
            </div>
